...
import com.dhw.propertyanimation.MainActivity;
import com.dhw.propertyanimation.app.MyApp;
import com.dhw.propertyanimation.util.NetWorkUtils;
 ...
 */
            ...
            okHttpClient = new OkHttpClient.Builder().connectTimeout(50, TimeUnit.SECONDS)
                    //添加OkHttp3的拦截器
